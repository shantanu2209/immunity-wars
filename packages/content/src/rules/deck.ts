 ...
 * novel (Pathogen X, injected rather than drawn) · needsHepB (hepatitis D).
 *
 * NOTE: `variant` is unreachable in play — see docs/FINDINGS.md #4. Ported as-is.
 */
export const DECK_MASTER: readonly Card[] = [
