...
- **PROPOSED, awaiting ruling (from the S25 check of CP1–2, 4 September 2026): THE PATHOGEN
  CARD, as its own piece between CP3 and CP4.** The old build showed a full card per disease
